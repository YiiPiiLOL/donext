...
V2.11.9 is a controlled testing release. The email/password implementation is intentionally not presented as the final production identity architecture. Before public release, use a production identity provider/managed authentication design and complete Google/Apple server-side verification.
