# DoNext V2.11.8 Verification

## Scope

V2.11.8 is based on the stable V2.11.4 frontend behavior and V2.11.7 real-app/auth foundation.
...
- No `DONEXT_API_TOKEN` dependency in the V2.11.8 Worker.
...
1. Deploy V2.11.8 to the DoNext Worker.
